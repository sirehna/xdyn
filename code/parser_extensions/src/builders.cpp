...
boost::optional<SurfaceElevationInterfacePtr>
SurfaceElevationBuilder<DefaultSurfaceElevation>::try_to_parse(
    ...
    if (model == "no waves")
    {
        if (yaml.empty())
        {
            THROW(__PRETTY_FUNCTION__,
                  ...
                  "No yaml data detected for default wave model (expected 'constant wave height in NED frame: {value: xx, unit: yy})'");
        }
...
boost::optional<WaveModelPtr>
WaveModelBuilder<Airy>::try_to_parse(
    const std::string& model,
    const DiscreteDirectionalWaveSpectrum& spectrum,
    const std::string& yaml
    ) const
{
...
WaveSpectralDensityPtr
SurfaceElevationBuilder<SurfaceElevationFromWaves>::parse_spectral_density(
    const YamlSpectra& spectrum
    ) const
{
    ...
    THROW(__PRETTY_FUNCTION__,
          InvalidInputException,
          "The wave spectral density specified in the YAML file is not understood by the simulator ('" << spectrum.spectral_density_type << "'): either it is misspelt or this simulator version is outdated.");
    return WaveSpectralDensityPtr();
}

WaveDirectionalSpreadingPtr
SurfaceElevationBuilder<SurfaceElevationFromWaves>::parse_directional_spreading(
    const YamlSpectra& spectrum) const
{
    ...
    THROW(__PRETTY_FUNCTION__,
          InvalidInputException,
          "The wave directional spreading specified in the YAML file is not understood by the simulator ('" << spectrum.directional_spreading_type << "'): either it is misspelt or this simulator version is outdated.");
    return WaveDirectionalSpreadingPtr ();
}

DiscreteDirectionalWaveSpectrum
SurfaceElevationBuilder<SurfaceElevationFromWaves>::parse_directional_spectrum(
    const YamlDiscretization& discretization,
    const YamlSpectra& spectrum
    ) const
{
...
WaveModelPtr SurfaceElevationBuilder<SurfaceElevationFromWaves>::parse_wave_model(
    const YamlDiscretization& discretization,
    const YamlSpectra& spectrum
    ) const
{
...
boost::optional<SurfaceElevationInterfacePtr>
SurfaceElevationBuilder<SurfaceElevationFromWaves>::try_to_parse(
    const std::string& model,
    const std::string& yaml
    ) const
{
...
boost::optional<WaveSpectralDensityPtr>
SpectrumBuilder<BretschneiderSpectrum>::try_to_parse(
    const std::string& model,
...
boost::optional<WaveSpectralDensityPtr>
SpectrumBuilder<JonswapSpectrum>::try_to_parse(
    const std::string& model,
    const std::string& yaml) const
{
    boost::optional<WaveSpectralDensityPtr > ret;
...
boost::optional<WaveSpectralDensityPtr>
SpectrumBuilder<PiersonMoskowitzSpectrum>::try_to_parse(
    const std::string& model,
    const std::string& yaml
    ) const
{
...
boost::optional<WaveSpectralDensityPtr>
SpectrumBuilder<DiracSpectralDensity>::try_to_parse(
    const std::string& model,
    const std::string& yaml
    ) const
{
...
boost::optional<WaveDirectionalSpreadingPtr> DirectionalSpreadingBuilder<DiracDirectionalSpreading>::try_to_parse(
    const std::string& model,
    const std::string& yaml
    ) const
{
...
boost::optional<WaveDirectionalSpreadingPtr> DirectionalSpreadingBuilder<Cos2sDirectionalSpreading>::try_to_parse(
    const std::string& model,
    const std::string& yaml
    ) const
{
