...
ELSEIF("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
    ...
    IF(CMAKE_BUILD_TYPE_UPPER MATCHES RELEASE)
        SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Ofast -DEIGEN_NO_DEBUG")
    ...
    ELSEIF(CMAKE_BUILD_TYPE_UPPER MATCHES PROFILE)
        SET(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Ofast -pg")
        SET(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Ofast -pg")
        SET(CMAKE_MODULE_LINKER_FLAGS "${CMAKE_MODULE_LINKER_FLAGS} -Ofast -pg")
        SET(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} -Ofast -pg")
    ENDIF()
