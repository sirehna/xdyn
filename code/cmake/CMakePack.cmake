...
IF(UNIX OR MSYS)
    ...
    IF(Subversion_FOUND)
        MACRO_SVNVERSION(SVNVERSION_RESULT)
        MESSAGE(STATUS "SVNVERSION_RESULT = ${SVNVERSION_RESULT}")
        SET(CPACK_PACKAGE_NAME "simulateurIrtJv_installer_${SVNVERSION_RESULT}")
    ELSE(Subversion_FOUND)
        SET(CPACK_PACKAGE_NAME "simulateurIrtJv_installer")
    ...
    SET(CPACK_PACKAGE_INSTALL_DIRECTORY "simulateurIrtJv")
    ...
    IF(WIN32)
        ...
        SET(CPACK_NSIS_INSTALLED_ICON_NAME "simulateurIrtJv_installer")
        SET(CPACK_NSIS_DISPLAY_NAME "${CPACK_PACKAGE_INSTALL_DIRECTORY}")
        SET(CPACK_NSIS_HELP_LINK "http:\\\\\\\\www.sirehna.com")
        SET(CPACK_NSIS_URL_INFO_ABOUT "http:\\\\\\\\www.sirehna.com")
        SET(CPACK_NSIS_CONTACT "guillaume.jacquenot@sirehna.com")
    ...
    ELSE(WIN32)
        ...
        #SET(CPACK_DEBIAN_PACKAGE_MAINTAINER "Guillaume Jacquenot")
