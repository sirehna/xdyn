...
std::string test_data::bug_3004()
{
    ...
    ss << "rotations convention: [psi, theta', phi'']\n"
       ...
       << "            y: {value: 0, unit: m}\n"
       << "            z: {value: 0, unit: m}\n"
       << "        mass: {value: 10250, unit: tonne} # Caution: 'ton' is the british ton which is 907.185 kg\n"
       << "        rigid body inertia matrix at the center of buoyancy projected in the body frame:\n"
       << "            frame: Ponton\n"
...
std::string test_data::bug_2984()
{
    ...
    ss << "rotations convention: [psi, theta', phi'']\n"
       ...
       << "            y: {value: 0, unit: m}\n"
       << "            z: {value: 0, unit: m} \n"
       << "        mass: {value: 6090., unit: tonne} # Caution: 'ton' is the british ton which is 907.185 kg\n"
       << "        rigid body inertia matrix at the center of buoyancy projected in the body frame:\n"
       << "            frame: ship\n"
...
std::string test_data::bug_3217()
{
    ...
    ss << "rotations convention: [psi, theta', phi'']\n"
       ...
       << "output:\n"
       << "   - format: map\n"
       << "     data: ['Fx(diffraction,Anthineas,Anthineas)', 'Fy(diffraction,Anthineas,Anthineas)', 'Fz(diffraction,Anthineas,Anthineas)', 'Mx(diffraction,Anthineas,Anthineas)', 'My(diffraction,Anthineas,Anthineas)', 'Mz(diffraction,Anthineas,Anthineas)']\n";
    return ss.str();
}
