...
std::string test_data::dummy_history()
{
    std::stringstream ss;
    ss << "t : 1234.5\n"
       << "x : [[0,10],[0.1,30],[0.2,50],[0.3,70],[0.4,90]]\n"
       << "y : [[0,11],[0.1,31],[0.2,51],[0.3,71],[0.4,91]]\n"
       << "z : [[0,12],[0.1,32],[0.2,52],[0.3,72],[0.4,92]]\n"
       << "u : [[0,13],[0.1,33],[0.2,53],[0.3,73],[0.4,93]]\n"
       << "v : [[0,14],[0.1,34],[0.2,54],[0.3,74],[0.4,94]]\n"
       << "w : [[0,15],[0.1,35],[0.2,55],[0.3,75],[0.4,95]]\n"
       << "p : [[0,16],[0.1,36],[0.2,56],[0.3,76],[0.4,96]]\n"
       << "q : [[0,17],[0.1,37],[0.2,57],[0.3,77],[0.4,97]]\n"
       << "r : [[0,18],[0.1,38],[0.2,58],[0.3,78],[0.4,98]]\n"
      << "qr : [[0,19],[0.1,39],[0.2,59],[0.3,79],[0.4,99]]\n"
      << "qi : [[0,20],[0.1,40],[0.2,60],[0.3,80],[0.4,100]]\n"
      << "qj : [[0,21],[0.1,41],[0.2,61],[0.3,81],[0.4,101]]\n"
      << "qk : [[0,22],[0.1,42],[0.2,62],[0.3,82],[0.4,102]]\n";
    return ss.str();
}