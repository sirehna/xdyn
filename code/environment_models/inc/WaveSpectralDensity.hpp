 ...
 *  \ingroup wave_models
 *  \section ex1 Example
 *  \snippet environment_models/unit_tests/src/WaveSpectrumTest.cpp WaveSpectrumTest example
 *  \section ex2 Expected output
 *  \snippet environment_models/unit_tests/src/WaveSpectrumTest.cpp WaveSpectrumTest expected output
 */
class WaveSpectralDensity
{
    public:
        ...
        /**  \brief Compute wave number, in infinite depth.
          ...
          *  \snippet environment_models/unit_tests/src/WaveSpectralDensityTest.cpp WaveSpectralDensityTest get_wave_number_example
