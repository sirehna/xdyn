...
{
    public:
        WaveModel(const FlatDiscreteDirectionalWaveSpectrum2& spectrum);
        virtual ~WaveModel();
        ...
        FlatDiscreteDirectionalWaveSpectrum2 get_spectrum() const {return spectrum;};

    private:
        WaveModel(); // Disabled

    protected:
        FlatDiscreteDirectionalWaveSpectrum2 spectrum;
