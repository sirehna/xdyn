...
{
    ASSERT_EQ("- {t: 0, x: 90, y: 91, z: 92, u: 93, v: 94, w: 95, p: 96, q: 97, r: 98, qr: 99, qi: 100, qj: 101, qk: 102}\n"
              ...
              "- {t: 0.4, x: 10, y: 11, z: 12, u: 13, v: 14, w: 15, p: 16, q: 17, r: 18, qr: 19, qi: 20, qj: 21, qk: 22}", encode_YamlStates(decode_YamlSimServerInputs(test_data::dummy_history()).states));
}
