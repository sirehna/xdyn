...
class RudderForceModel : public ControllableForceModel
{
    public:
        ...
        ssc::kinematics::Point get_ship_speed(
            const BodyStates& states,
            const double t
            ) const;
        ...
        struct RudderModel
        {
            ...
            /**  \brief Calculates the angle of incidence of the fluid, inside & outside wake
              ...
              */
            InOutWake<double> get_fluid_angle(
                const InOutWake<ssc::kinematics::Point>& Vs   //!< Ship speed relative to the fluid, inside & outside wake
                ) const;
