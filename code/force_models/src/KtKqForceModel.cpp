...
double KtKqForceModel::get_Kt(std::map<std::string,double>, const double J) const
{
    return pimpl->Kt.f(J);
}

double KtKqForceModel::get_Kq(std::map<std::string,double>, const double J) const
{
    return pimpl->Kq.f(J);
}
