...
std::vector<std::vector<size_t> > MeshIntersector::group_connected_edges_into_facets(const std::vector<size_t>& edges_index, const std::vector<std::pair<size_t,size_t> >& edges)
{
