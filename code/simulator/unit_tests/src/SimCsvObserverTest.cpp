...
TEST_F(SimCsvObserverTest, can_simulate_environment_with_no_system)
{
    ...
    expected << "waves:\n"
             ...
             << "  timesteps:\n"
             << "    - t: 0\n"
             << "      z: [-49.098,-49.098,-49.098,-49.098,-49.0979,-48.6016,-48.6016,-48.6016,-48.6016]\n"
             << "    - t: 0.1\n"
             << "      z: [-49.6365,-49.6365,-49.6364,-49.6364,-49.6364,-49.1101,-49.1101,-49.1101,-49.1101]\n";
...
TEST_F(SimCsvObserverTest, can_simulate_both_environment_and_system)
{
    ...
    expected << "waves:\n"
             ...
             << "      x: [1,2,3,4,5,1,2,3,4]\n"
             << "      y: [1,1,1,1,1,2,2,2,2]\n"
             << "      z: [-30.838,-30.838,-30.838,-30.8379,-30.8379,-30.3429,-30.3428,-30.3428,-30.3428]\n"
             << "    - t: 0.1\n"
             << "      x: [0.9,1.9,2.9,3.9,4.9,0.9,1.9,2.9,3.9]\n"
             << "      y: [0.8,0.8,0.8,0.8,0.8,1.8,1.8,1.8,1.8]\n"
             << "      z: [-31.4784,-31.4784,-31.4784,-31.4784,-31.4784,-30.8921,-30.8921,-30.8921,-30.8921]\n";
    ASSERT_EQ(expected.str(), wave_stream.str());
}
