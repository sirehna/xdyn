Extinction en roulis (angle initial de 10deg -> décalage de 10deg par rapport à la position d'équilibre)
A réaliser : comparaison des 6 vitesses et 6 déplacements entre simulateur SOS (voir fichier Excel "comparaison_extinctionRoulis_phiIni_10.xlsx", onglet "SOS") et X-Dyn.

Extinction en tangage (angle initial de 10deg -> décalage de ~10.3deg par rapport à la position d'équilibre)
A réaliser : comparaison des 6 vitesses et 6 déplacements entre simulateur SOS (voir fichier Excel "comparaison_extinctionTangage_thetaIni_10.xlsx", onglet "SOS") et X-Dyn.
