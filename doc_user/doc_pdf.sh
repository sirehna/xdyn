#!/bin/sh
cat metadata.yaml introduction.md interfaces_utilisateur.md reperes_et_conventions.md modeles_environnementaux.md calcul_de_GM.md courbes_de_GZ.md solver.md diffraction_radiation.md modeles_efforts_commandes_et_non_commandes.md tutorial_*.md > concatenated_doc.md
